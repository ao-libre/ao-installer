...
!define AO_BASIC_REGKEY "ArgentumOnlineLibre"
...
; OCX y DLLs
  ...
  !insertmacro InstallLib REGDLL $ALREADY_INSTALLED REBOOT_PROTECTED \
     "${DEPENDS_FOLDER}\AOFX.DLL" "$SYSDIR\AOFX.DLL" "$SYSDIR"
...
; OCX y DLLs
  ...
  !insertmacro UnInstallLib REGDLL SHARED NOREMOVE "$SYSDIR\AOFX.DLL"
  ...
  !insertmacro UnInstallLib REGDLL SHARED NOREMOVE "$SYSDIR\VBALPROGBAR6.OCX"
